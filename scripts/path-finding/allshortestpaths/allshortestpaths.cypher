...
CALL algo.allShortestPaths.stream(null, {nodeQuery:"Place", defaultValue:1.0, direction:"BOTH"})
...
CALL algo.allShortestPaths.stream("distance", {nodeQuery:"Place", defaultValue:1.0, direction:"BOTH"})
YIELD sourceNodeId, targetNodeId, distance
